/**
 * leadership.js — Accordion toggle for Leadership sections E–K
 */
(function () {
  "use strict";

  function initLeadershipAccordion() {
    var items = document.querySelectorAll(".lead-acc .about-acc__item");
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initLeadershipAccordion);
  } else {
